...
func (a *App) SetServerRoot(rootPath string) error {
	...
	a.orchestrator.StopAll(a.getContext())
	...
	a.runtime.EventsEmit(a.getContext(), "environment_changed", a.cfg)
	return nil
}

// SelectServerRoot opens a directory dialog to select the Ostenia apps location
func (a *App) SelectServerRoot() (string, error) {
	selectedDir, err := a.runtime.OpenDirectoryDialog(a.getContext(), wruntime.OpenDialogOptions{Title: "Select Ostenia Apps Location"})
	if err != nil {
		return "", err
	}
	if selectedDir != "" {
...
func (a *App) SelectWWWRoot() (string, error) {
	selectedDir, err := a.runtime.OpenDirectoryDialog(a.getContext(), wruntime.OpenDialogOptions{Title: "Select Server Root (www)"})
	if err != nil {
		return "", err
	}
	if selectedDir != "" {
