...
const ProxyTab: React.FC<ProxyTabProps> = ({ addToast }) => {
 ...
 <>
 <button type="button" className="fixed inset-0 z-10 w-full h-full bg-transparent border-none p-0 cursor-default focus:outline-none" onKeyDown={handleActionKey(() => setOpenTerminalDropdown(null))} onClick={() => setOpenTerminalDropdown(null)} />
