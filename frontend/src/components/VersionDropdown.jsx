...
function VersionDropdown({ current, options, onChange, isOpen, onToggle, allowCustom, onCustomClick }) {
  return (
    <div className="relative">
      ...
      {isOpen && (
        <>
          ...
          <div className="absolute top-full left-0 mt-1 w-32 max-h-56 overflow-y-auto bg-white dark:bg-slate-900 shadow-2xl border border-slate-200 dark:border-white/10 rounded-sm backdrop-blur-xl z-[70] animate-in fade-in zoom-in-95 duration-200">
