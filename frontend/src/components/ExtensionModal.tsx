        ...
        <div className="p-4 border-b border-slate-200 dark:border-white/5 flex items-center justify-between shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] text-slate-500 dark:text-slate-400 font-bold uppercase italic opacity-70 mt-0.5 tracking-tight">
                Managed via php.ini
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
            {filteredExtensions.map((ext) => (
              ...
              >
                ...
                />
                <span className="text-[11px] font-bold truncate group-hover/ext:translate-x-0.5 transition-transform">
                  {ext.name}
                </span>
                {ext.enabled && (
            ...
            {filteredExtensions.length === 0 && (
              <div className="col-span-full py-12 text-center">
                <p className="text-xs font-bold text-slate-500 uppercase tracking-widest opacity-50">
