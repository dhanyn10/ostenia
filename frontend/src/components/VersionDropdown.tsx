...
const VersionDropdown: React.FC<VersionDropdownProps> = ({ current, options, onChange, isOpen, onToggle, allowCustom, onCustomClick }) => {
 ...
 {isOpen && (
 <>
 <div className="fixed inset-0 z-[60]" role="button" tabIndex={0} onKeyDown={handleActionKey(onToggle)} onClick={onToggle} />
 ...
 className={cn(
 "px-2 py-1 rounded-sm text-[9px] font-bold cursor-pointer transition-all outline-none",
