      ...
      <div className="shrink-0 pt-4 pb-3 grid grid-cols-2 gap-3">
        <div className="bg-white/50 dark:bg-slate-900/40 backdrop-blur-xl rounded-sm p-4 border border-slate-200 dark:border-white/5 shadow-sm">
          ...
          <div className="flex items-center gap-2">
            ...
            <button onClick={handleBrowseAppsLocation} title="Browse Directory" className="px-2 py-1.5 bg-slate-200 dark:bg-white/10 hover:bg-slate-300 dark:hover:bg-white/20 text-slate-600 dark:text-slate-300 rounded-sm text-[10px] font-bold uppercase tracking-wider transition-all">Browse</button>
        ...
        <div className="bg-white/50 dark:bg-slate-900/40 backdrop-blur-xl rounded-sm p-4 border border-slate-200 dark:border-white/5 shadow-sm">
          ...
          <div className="flex items-center gap-2">
            ...
            <button onClick={handleBrowseServerRoot} title="Browse Directory" className="px-2 py-1.5 bg-slate-200 dark:bg-white/10 hover:bg-slate-300 dark:hover:bg-white/20 text-slate-600 dark:text-slate-300 rounded-sm text-[10px] font-bold uppercase tracking-wider transition-all">Browse</button>
