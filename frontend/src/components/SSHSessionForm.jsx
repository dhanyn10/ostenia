    ...
    <div className="w-[380px] bg-white dark:bg-mui-dark-bg border-l border-mui-grey-200 dark:border-white/10 flex flex-col h-full animate-in slide-in-from-right duration-200 shrink-0">
      ...
      <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-5 space-y-6 custom-scrollbar">
        <div className="space-y-4">
          ...
          <div>
            <label className="block text-[10px] font-bold text-mui-grey-400 uppercase tracking-widest mb-1.5 ml-0.5">Authentication Method</label>
            <div className="flex p-1 bg-mui-grey-100 dark:bg-mui-grey-900 rounded-md">
              <button
                ...
                className={clsx(
                  ...
                  formData.authMethod === 'password' ? "bg-white dark:bg-mui-blue-600 text-mui-blue-600 dark:text-white shadow-sm" : "text-mui-grey-500 hover:text-mui-grey-700 dark:hover:text-mui-grey-300"
                )}
              >
                Password
              </button>
              <button
                ...
                className={clsx(
                  "flex-1 py-1.5 text-[11px] font-bold rounded transition-all",
                  formData.authMethod === 'key' ? "bg-white dark:bg-mui-blue-600 text-mui-blue-600 dark:text-white shadow-sm" : "text-mui-grey-500 hover:text-mui-grey-700 dark:hover:text-mui-grey-300"
                )}
              >
                Key File
              </button>
