...
describe('CircularProgress Component', () => {
 ...
 render(<CircularProgress percentage={50} speed="1.5 MB/s" downloaded="10 MB" />)
 ...
 const container = screen.getByText('50%').closest('div').parentElement.parentElement
 ...
 const { container } = render(<CircularProgress percentage={0} status="Streaming..." />)
