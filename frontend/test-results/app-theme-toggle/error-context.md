...
- Name: app.spec.js >> theme toggle
- Location: src/test/app.spec.js:17:1
...
Locator: getByTitle(/Switch to (Dark|Light) Mode/)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByTitle(/Switch to (Dark|Light) Mode/)
